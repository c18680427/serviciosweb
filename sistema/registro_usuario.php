...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario']) || empty($_POST['clave']) || empty($_POST['rol'])) {
        ...
        $query_email = mysqli_query($conexion, "SELECT * FROM usuario where correo = '$email'");
        $result_email = mysqli_fetch_array($query_email);
        $query_username = mysqli_query($conexion, "SELECT * FROM usuario where usuario = '$user'");
        $result_username = mysqli_fetch_array($query_username);
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="lista_usuarios.php" class="btn btn-primary">Ver usuarios</a>
