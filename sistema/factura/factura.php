	...
	<div id="page_pdf">
		<table id="factura_head">
			<tr>
				<td class="logo_factura">
					<div>
						<img src="img/logo_2.jpg" style="width: 90px;">
					</div>
				</td>
				<td class="info_empresa">
					...
					?>
						<div>
							...
							<p>RFC: <?php echo $configuracion['dni']; ?></p>
				...
				<td class="info_factura">
					<div class="round">
						<span class="h3"><?php if ($factura['codcliente'] == 1) echo 'TICKET'; else echo 'FACTURA'; ?></span>
						<?php echo "<p> N°. Venta: <strong>"; echo $factura['nofactura']; echo "</strong></p>"; ?>
		...
		<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				<tr>
					<td colspan="3" class="textright"><span>SUBTOTAL s/IVA.</span></td>
				...
				<tr>
					<td colspan="3" class="textright"><span>TOTAL c/IVA.</span></td>
					<td class="textright"><span><?php echo $total; ?></span></td>
				</tr>
			</tfoot>
		</table>
		<div>
			<!--<p class="nota">Si usted tiene preguntas sobre esta Factura, pongase en contacto con nombre, teléfono y su correo clectrónico</p>-->
