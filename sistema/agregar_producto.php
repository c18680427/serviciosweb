...
if (!empty($_POST)) {
    ...
    if (!empty($_POST['cantidad']) || !empty($_POST['precio']) || !empty($_POST['producto_id'])) {
        ...
        if ($query_insert) {
            ...
            if (!empty($query_upd) AND $result_pro > 0) {
                        ...
                        <div class="col-lg-6 m-auto">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" placeholder="Ingrese nombre del precio" name="precio" class="form-control" value="<?php echo $data_producto['precio']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="cantidad">Sumar Unidades</label>
                                    <input type="number" min="1" placeholder="Ingrese cantidad a sumar" name="cantidad" id="cantidad" class="form-control">
                                </div>
