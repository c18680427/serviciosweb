				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							<div class="form-group">
								<label>RFC:</label>
								<input type="text" name="txtDni" value="<?php echo $dni; ?>" id="txtDni" placeholder="RFC de la Empresa" required class="form-control">
							</div>
							<div class="form-group">
								<label>Nombre:</label>
							...
							<div class="form-group">
								<label>Eslogan:</label>
								<input type="text" name="txtRSocial" class="form-control" value="<?php echo $razonSocial; ?>" id="txtRSocial" placeholder="Eslogan de la Empresa">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" name="txtDirEmpresa" class="form-control" value="<?php echo $dirEmpresa; ?>" id="txtDirEmpresa" placeholder="Direción de la Empresa" required>
							</div>
							<!--<div class="form-group">
								<label>IGV (%):</label>
